...
urlpatterns = [
    ...
    path("integrations/alerts", integration_views.IntegrationAlertListView.as_view(), name="integration-alert-list"),
    path("integrations/alerts/<str:id>/acknowledge", integration_views.IntegrationAlertAcknowledgeView.as_view(), name="integration-alert-ack"),
    path("integrations/alerts/<str:id>/resolve", integration_views.IntegrationAlertResolveView.as_view(), name="integration-alert-resolve"),
    path("integrations/audit-logs", integration_views.IntegrationAuditLogsView.as_view(), name="integration-audit-logs"),
